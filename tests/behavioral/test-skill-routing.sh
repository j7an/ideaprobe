...
output=$(run_with_timeout "$TIMEOUT" claude -p "Using IdeaProbe, what skill should someone use if they don't have a business idea yet? Answer with just the skill name." 2>&1 || true)
