...
output=$(run_with_timeout "$TIMEOUT" claude -p "In ideaprobe:idea-validation, how many research agents are dispatched and should they run sequentially or in parallel? Answer in one sentence." 2>&1 || true)
