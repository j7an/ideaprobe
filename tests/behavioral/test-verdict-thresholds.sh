...
output=$(run_with_timeout "$TIMEOUT" claude -p "In ideaprobe:idea-validation, what verdict (GO, EXPLORE, PIVOT, or STOP) would a total score of 45 out of 100 receive? Answer in one word." 2>&1 || true)
